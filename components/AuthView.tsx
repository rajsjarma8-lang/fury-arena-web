...
import { verifyCredentials, checkEmailAvailability, signInWithGooglePopup } from '../firebase';
...
const AuthView: React.FC<AuthViewProps> = ({ onLogin, t, settings }) => {
  ...
  const [formData, setFormData] = useState({ email: '', name: '', phone_number: '', password: '' });
          ...
          <div className="mt-10 text-center">
            <button 
              onClick={() => {
                setIsLogin(!isLogin);
                setError(null);
                setFormData({ email: '', name: '', phone_number: '', password: '' });
              }} 
